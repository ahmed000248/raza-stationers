...
import { ArrowLeft, ArrowRight, Truck, MapPin, Store } from "lucide-react"
...
export default function CheckoutPage() {
  ...
  const [address, setAddress] = React.useState("Main Market, Urdu Bazar")
    ...
    <div className="min-h-screen px-3 py-8 sm:px-6 sm:py-10">
      <div className="mx-auto w-full max-w-6xl space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-border pb-6">
          ...
          <Badge variant="amber" className="px-3 py-1 text-xs shrink-0">Backend Rebuild in Progress</Badge>
        </div>
