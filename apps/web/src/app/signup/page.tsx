...
import { User, ArrowLeft, ArrowRight, FileText, Loader2, CheckCircle2 } from "lucide-react"
          ...
          <div className="p-8 rounded-3xl border border-amber-500/30 bg-amber-500/10 space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground max-w-md mx-auto">
                We sent a confirmation link to <strong className="text-foreground">{email}</strong>. Please check your inbox to complete signup.
              </p>
            </div>
          </div>
        ) : (
