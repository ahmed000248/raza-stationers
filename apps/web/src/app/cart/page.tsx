      ...
      <div className="mx-auto w-full max-w-6xl space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-border pb-6">
          <div>
            ...
            <h1 className="mt-1 flex flex-wrap items-center gap-2 font-heading text-2xl font-bold tracking-tight text-[var(--color-ink-900)] sm:gap-3 sm:text-4xl">
        ...
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="flex flex-col items-start gap-3 border-t border-border/40 pt-4 sm:flex-row sm:items-center sm:justify-between">
                <Link
                  href="/catalogue"
