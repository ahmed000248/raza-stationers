...
"[project]/apps/web/src/lib/gsap/src/Observer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ /* eslint-disable */ let gsap, _coreInitted, _clamp, _win, _doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _context, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _startup = 1, _observers = [], _scrollers = [], _proxies = [], _getTime = Date.now, _bridge = (name, value)=>value, _integrate = ()=>{
...
"[project]/apps/web/src/lib/gsap/src/ScrollTrigger.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/Observer.js [app-client] (ecmascript)");
;
let gsap, _coreInitted, _win, _doc, _docEl, _body, _root, _resizeDelay, _toArray, _clamp, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = (value, type, self)=>{
...
}, _keepClamp = (value, clamp)=>clamp && (!_isString(value) || value.substr(0, 6) !== "clamp(") ? "clamp(" + value + ")" : value, _rafBugFix = ()=>_enabled && requestAnimationFrame(_rafBugFix), _pointerDownHandler = ()=>_pointerIsDown = 1, _pointerUpHandler = ()=>_pointerIsDown = 0, _passThrough = (v)=>v, _round = (value)=>Math.round(value * 100000) / 100000 || 0, _windowExists = ()=>("TURBOPACK compile-time value", "object") !== "undefined", _getGSAP = ()=>gsap || _windowExists() && (gsap = window.gsap) && gsap.registerPlugin && gsap, _isViewport = (e)=>!!~_root.indexOf(e), _getViewportDimension = (dimensionProperty)=>(dimensionProperty === "Height" ? _100vh : _win["inner" + dimensionProperty]) || _docEl["client" + dimensionProperty] || _body["client" + dimensionProperty], _getBoundsFunc = (element)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(element, "getBoundingClientRect") || (_isViewport(element) ? ()=>{
        _winOffsets.width = _win.innerWidth;
        _winOffsets.height = _100vh;
        return _winOffsets;
    } : ()=>_getBounds(element)), _getSizeFunc = (scroller, isViewport, { d, d2, a })=>(a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(scroller, "getBoundingClientRect")) ? ()=>a()[d] : ()=>(isViewport ? _getViewportDimension(d2) : scroller["client" + d2]) || 0, _getOffsetsFunc = (element, isViewport)=>!isViewport || ~__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_proxies"].indexOf(element) ? _getBoundsFunc(element) : ()=>_winOffsets, _maxScroll = (element, { s, d2, d, a })=>Math.max(0, (s = "scroll" + d2) && (a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(element, s)) ? a() - _getBoundsFunc(element)()[d] : _isViewport(element) ? (_docEl[s] || _body[s]) - _getViewportDimension(d2) : element[s] - element["offset" + d2]), _iterateAutoRefresh = (func, events)=>{
    ...
    let e = _doc.createElement("div"), useFixedPosition = _isViewport(container) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(container, "pinType") === "fixed", isScroller = type.indexOf("scroller") !== -1, parent = useFixedPosition ? _body : container.tagName === "IFRAME" ? container.contentDocument.body : container, isStart = type.indexOf("start") !== -1, color = isStart ? startColor : endColor, css = "border-color:" + color + ";font-size:" + fontSize + ";color:" + color + ";font-weight:" + fontWeight + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
    css += "position:" + ((isScroller || containerAnimation) && useFixedPosition ? "fixed;" : "absolute;");
    (isScroller || containerAnimation || !useFixedPosition) && (css += (direction === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"] ? _right : _bottom) + ":" + (offset + parseFloat(indent)) + "px;");
    ...
    if (!_normalizer || !_normalizer.isPressed || _normalizer.startX > _body.clientWidth) {
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache++;
        if (_normalizer) {
...
}, _recordScrollPositions = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].forEach((obj)=>_isFunction(obj) && ++obj.cacheID && (obj.rec = obj())), _revertAll = (kill, media)=>{
    let trigger;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache++;
    (force || !_refreshingAll) && __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].forEach((obj)=>_isFunction(obj) && obj.cacheID++ && (obj.rec = 0));
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].forEach((obj)=>{
        if (_isFunction(obj)) {
    ...
    if (!pin._gsap.swappedIn) {
        ...
        spacerStyle[_width] = _getSize(pin, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"]) + _px;
        spacerStyle[_height] = _getSize(pin, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]) + _px;
...
_parsePosition = (value, trigger, scrollerSize, direction, scroll, marker, markerScroller, self, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation, clampZeroProp)=>{
    ...
    if (!_isNumber(value)) {
        ...
        element = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(trigger, self) || _body;
...
_getTweenCreator = (scroller, direction)=>{
    let getScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])(scroller, direction), prop = "_scroll" + direction.p2, getTween = (scrollTo, vars, initialValue, change1, change2)=>{
...
class ScrollTrigger {
    ...
    init(vars, animation) {
        ...
        let { onUpdate, toggleClass, id, onToggle, onRefresh, scrub, trigger, pin, pinSpacing, invalidateOnRefresh, anticipatePin, onScrubComplete, onSnapComplete, once, snap, pinReparent, pinSpacer, containerAnimation, fastScrollEnd, preventOverlaps } = vars, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"] : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"], isToggle = !scrub && scrub !== 0, scroller = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(vars.scroller || _win), scrollerCache = gsap.core.getCache(scroller), isViewport = _isViewport(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [
            vars.onEnter,
            vars.onLeave,
            vars.onEnterBack,
            vars.onLeaveBack
        ], toggleActions = isToggle && vars.toggleActions.split(" "), markers = "markers" in vars ? vars.markers : _defaults.markers, borderWidth = isViewport ? 0 : parseFloat(_getComputedStyle(scroller)["border" + direction.p2 + _Width]) || 0, self = this, onRefreshInit = vars.onRefreshInit && (()=>vars.onRefreshInit(self)), getScrollerSize = _getSizeFunc(scroller, isViewport, direction), getScrollerOffsets = _getOffsetsFunc(scroller, isViewport), lastSnap = 0, lastRefresh = 0, prevProgress = 0, scrollFunc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])(scroller, direction), tweenTo, pinCache, snapFunc, scroll1, scroll2, start, end, markerStart, markerEnd, markerStartTrigger, markerEndTrigger, markerVars, executingOnRefresh, change, pinOriginalState, pinActiveState, pinState, spacer, offset, pinGetter, pinSetter, pinStart, pinChange, spacingStart, spacerState, markerStartSetter, pinMoves, markerEndSetter, cs, snap1, snap2, scrubTween, scrubSmooth, snapDurClamp, snapDelayedCall, prevScroll, prevAnimProgress, caMarkerSetter, customRevertReturn;
        ...
        scrollerCache.tweenScroll = scrollerCache.tweenScroll || {
            top: _getTweenCreator(scroller, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]),
            left: _getTweenCreator(scroller, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"])
        };
        ...
        if (snap) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].forEach((o)=>_isFunction(o) && o.target === (isViewport ? _doc.scrollingElement || _docEl : scroller) && (o.smooth = false)); // note: set smooth to false on both the vertical and horizontal scroll getters/setters
        ...
        id && (_ids[id] = self);
        trigger = self.trigger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(trigger || pin !== true && pin);
        ...
        pin = pin === true ? trigger : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(pin);
        ...
        if (pin) {
            ...
            if (!pinCache.spacer) {
                if (pinSpacer) {
                    pinSpacer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(pinSpacer);
        ...
        if (markers) {
            ...
            let content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(scroller, "content") || scroller);
            ...
            if (!useFixedPosition && !(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_proxies"].length && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getProxyProp"])(scroller, "fixedMarkers") === true)) {
        ...
        self.refresh = (soft, force, position, pinOffset)=>{
            ...
            let size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max = containerAnimation ? containerAnimation.duration() : _maxScroll(scroller, direction), isFirstRefresh = change <= 0.01 || !change, offset = 0, otherPinOffset = pinOffset || 0, parsedEnd = _isObject(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = _isObject(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self.pinnedContainer = vars.pinnedContainer && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(vars.pinnedContainer, self), triggerIndex = trigger && Math.max(0, _triggers.indexOf(self)) || 0, i = triggerIndex, cs, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
            ...
            if (pin && !(_clampingMax && self.end >= _maxScroll(scroller, direction))) {
                cs = _getComputedStyle(pin);
                isVertical = direction === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"];
                ...
                oppositeScroll = useFixedPosition && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])(scroller, isVertical ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"] : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"])();
                if (pinSpacing) {
                    spacerState = [
                    ...
                    if (!useFixedPosition) {
                        ...
                        if (pinReparent) {
                            if (!reset && (isActive || isAtMax)) {
                                ...
                                _reparent(pin, _body, bounds.top + (direction === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"] ? offset : 0) + _px, bounds.left + (direction === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"] ? 0 : offset) + _px);
                            } else {
        ...
        if (animation && animation.add && !change) {
            ...
            self.update = ()=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache++; // otherwise a cached scroll position may get used in the refresh() in a very rare scenario, like if ScrollTriggers are created inside a DOMContentLoaded event and the queued requestAnimationFrame() fires beforehand. See https://gsap.com/community/forums/topic/41267-scrolltrigger-breaks-on-refresh-when-using-domcontentloaded/
    ...
    static disable(reset, kill) {
        ...
        for(let i = 0; i < __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].length; i += 3){
            _wheelListener(_removeListener, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i + 1]);
            _wheelListener(_removeListener, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i + 2]);
        }
    }
    static enable() {
        _win = window;
        ...
        if (gsap) {
            ...
            if (_body) {
                ...
                _refresh100vh();
                _rafBugFix();
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].register(gsap);
                // isTouch is 0 if no touch, 1 if ONLY touch, and 2 if it can accommodate touch but also other types like mouse/pointer.
                ScrollTrigger.isTouch = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].isTouch;
                _fixIOSBug = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent); // since 2017, iOS has had a bug that causes event.clientX/Y to be inaccurate when a scroll occurs, thus we must alternate ignoring every other touchmove event to work around it. See https://bugs.webkit.org/show_bug.cgi?id=181954 and https://codepen.io/GreenSock/pen/ExbrPNa/087cef197dc35445a0951e8935c41503
                _ignoreMobileResize = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].isTouch === 1;
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"].m = Math.round(bounds.top + __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"].sc()) || 0; // accommodate the offset of the <body> caused by margins and/or padding
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"].m = Math.round(bounds.left + __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"].sc()) || 0;
                ...
                for(i = 0; i < __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].length; i += 3){
                    _wheelListener(_removeListener, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i + 1]);
                    _wheelListener(_removeListener, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"][i + 2]);
                }
            } else if (_doc) {
    ...
    static scrollerProxy(target, vars) {
        let t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(target), i = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].indexOf(t), isViewport = _isViewport(t);
        if (~i) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].splice(i, isViewport ? 6 : 2);
        }
        if (vars) {
            isViewport ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_proxies"].unshift(_win, vars, _body, vars, _docEl, vars) : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_proxies"].unshift(t, vars);
        }
    }
    ...
    static isInViewport(element, ratio, horizontal) {
        let bounds = (_isString(element) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(element) : element).getBoundingClientRect(), offset = bounds[horizontal ? _width : _height] * ratio || 0;
        return horizontal ? bounds.right - offset > 0 && bounds.left + offset < _win.innerWidth : bounds.bottom - offset > 0 && bounds.top + offset < _win.innerHeight;
    }
    static positionInViewport(element, referencePoint, horizontal) {
        _isString(element) && (element = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(element));
...
ScrollTrigger.update = (force)=>++__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache && _updateAll(force === true ? 2 : 0);
ScrollTrigger.clearScrollMemory = _clearScrollMemory;
ScrollTrigger.maxScroll = (element, horizontal)=>_maxScroll(element, horizontal ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"] : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]);
ScrollTrigger.getScrollFunc = (element, horizontal)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(element), horizontal ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"] : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]);
...
let _clampScrollAndGetDurationMultiplier = (scrollFunc, current, end, max)=>{
    ...
    if (direction === true) {
        ...
        target.style.touchAction = direction === true ? "auto" : direction ? "pan-" + direction + (__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].isTouch ? " pinch-zoom" : "") : "none"; // note: Firefox doesn't support it pinch-zoom properly, at least in addition to a pan-x or pan-y.
    }
...
_inputObserver = (target, type, inputs, nested)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].create({
        target: target,
        capture: true,
        debounce: false,
        lockAxis: true,
        ...
        onDrag: nested,
        onScroll: nested,
        onEnable: ()=>inputs && _addListener(_doc, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].eventTypes[0], _captureInputs, false, true),
        onDisable: ()=>_removeListener(_doc, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].eventTypes[0], _captureInputs, true)
    ...
    let { normalizeScrollX, momentum, allowNestedScroll, onRelease } = vars, self, maxY, target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(vars.target) || _docEl, smoother = gsap.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getTarget"])(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]), scrollFuncX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getScrollFunc"])(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"]), scale = 1, initialScale = (__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"].isTouch && _win.visualViewport ? _win.visualViewport.scale * _win.visualViewport.width : _win.outerWidth) / _win.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction(momentum) ? ()=>momentum(self) : ()=>momentum || 2.8, lastRefreshID, skipTouchMove, inputObserver = _inputObserver(target, vars.type, true, allowNestedScroll), resumeTouchMove = ()=>skipTouchMove = false, scrollClampX = _passThrough, scrollClampY = _passThrough, updateClamps = ()=>{
        maxY = _maxScroll(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]);
        scrollClampY = _clamp(_fixIOSBug ? 1 : 0, maxY);
        normalizeScrollX && (scrollClampX = _clamp(0, _maxScroll(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"])));
        ...
        if (skipTouchMove) {
            ...
            if (content && scroll !== scrollFuncY.v + scrollFuncY.offset) {
                ...
                scrollFuncY.cacheID = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache;
                _updateAll();
            }
            return true;
        }
    ...
    vars.onRelease = vars.onGestureStart = (self, wasDragging)=>{
        ...
        if (!wasDragging) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"].cache++; // make sure we're pulling the non-cached value
            ...
            if (normalizeScrollX) {
                ...
                dur *= _clampScrollAndGetDurationMultiplier(scrollFuncX, currentScroll, endScroll, _maxScroll(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_horizontal"]));
                tween.vars.scrollX = scrollClampX(endScroll);
            }
            currentScroll = scrollFuncY();
            endScroll = currentScroll + dur * 0.05 * -self.velocityY / 0.227; // the constant .227 is from power4(0.05)
            dur *= _clampScrollAndGetDurationMultiplier(scrollFuncY, currentScroll, endScroll, _maxScroll(target, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_vertical"]));
    ...
    self = new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"](vars);
...
ScrollTrigger.observe = (vars)=>new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"](vars);
ScrollTrigger.normalizeScroll = (vars)=>{
    ...
    let normalizer = vars instanceof __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"] ? vars : _getScrollNormalizer(vars);
    _normalizer && _normalizer.target === normalizer.target && _normalizer.kill();
    _isViewport(normalizer.target) && (_normalizer = normalizer);
    return normalizer;
};
ScrollTrigger.core = {
    _getVelocityProp: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getVelocityProp"],
    _inputObserver,
    _scrollers: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_scrollers"],
    _proxies: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_proxies"],
    bridge: {
...
"[project]/apps/web/src/lib/gsap/src/ScrollToPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ let gsap, _coreInitted, _window, _docEl, _body, _toArray, _config, ScrollTrigger, _windowExists = ()=>("TURBOPACK compile-time value", "object") !== "undefined", _getGSAP = ()=>gsap || _windowExists() && (gsap = window.gsap) && gsap.registerPlugin && gsap, _isString = (value)=>typeof value === "string", _isFunction = (value)=>typeof value === "function", _max = (element, axis)=>{
...
"[project]/apps/web/src/lib/gsap/src/utils/matrix.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/lib/gsap/src/Flip.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/matrix.js [app-client] (ecmascript)");
;
let _id = 1, _toArray, gsap, _batch, _batchAction, _body, _closestTenth, _getStyleSaver, _forEachBatch = (batch, name)=>batch.actions.forEach((a)=>a.vars[name] && a.vars[name](a)), _batchLookup = {}, _RAD2DEG = 180 / Math.PI, _DEG2RAD = Math.PI / 180, _emptyObj = {}, _dashedNameLookup = {}, _memoizedRemoveProps = {}, _listToArray = (list)=>typeof list === "string" ? list.split(" ").join("").split(",") : list, _callbacks = _listToArray("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"), _removeProps = _listToArray("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"), _getEl = (target)=>_toArray(target)[0] || console.warn("Element not found:", target), _round = (value)=>Math.round(value * 10000) / 10000 || 0, _toggleClass = (targets, className, action)=>targets.forEach((el)=>el.classList[action](className)), _reserved = {
    ...
    return cache.gMatrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(el, true, false, true);
    ...
    if (uncache) {
        ...
        if (elState.simple) {
            ...
            result.matrix = new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix2D"](1, 0, 0, 1, bounds.left + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getDocScrollLeft"])(), bounds.top + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getDocScrollTop"])());
        } else {
            result.matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(element, false, false, true);
        }
    }
    ...
    if (simple || !parent) {
        ...
        cache.y = y + "px";
        cache.renderTransform(1, cache);
        matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(fitChild || element, false, false, true);
        ...
        for(i = 0; i < comps.length; i++){
            ...
            if (prune && !a.isDifferent(b) && !comp.entering) {
                ...
                if (nested && !(comp.sd < 0) && i) {
                    a = comp.a = a.clone({
                        matrix: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(el, false, false, true)
                    });
                }
                if (b.isVisible && a.isVisible) {
                    if (comp.sd < 0) {
                        ...
                        state.matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(el, false, false, true);
...
class FlipState {
    ...
    fit(state, scale, nested) {
        ...
        for(; i < elStatesInOrder.length; i++){
            ...
            nested && (fromNode.matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(fromNode.element, false, false, true)); // moving a parent affects the position of children
            toNode = toElStates[fromNode.id];
            toNode && _fit(fromNode, toNode, scale, true, 0, fromNode);
            fromNode.matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(fromNode.element, false, false, true);
        }
        return this;
    }
...
class ElementState {
    ...
    update(props, simple) {
        let self = this, element = self.element, getProp = gsap.getProperty(element), cache = gsap.core.getCache(element), bounds = element.getBoundingClientRect(), bbox = element.getBBox && typeof element.getBBox === "function" && element.nodeName.toLowerCase() !== "svg" && element.getBBox(), m = simple ? new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix2D"](1, 0, 0, 1, bounds.left + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getDocScrollLeft"])(), bounds.top + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getDocScrollTop"])()) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(element, false, false, true);
        ...
        self.ctm = element.getCTM && element.nodeName.toLowerCase() === "svg" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_getCTM"])(element).inverse();
...
class Flip {
    ...
    static convertCoordinates(fromElement, toElement, point) {
        let m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(toElement, true, true).multiply((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(fromElement));
    ...
    static register(core) {
        ...
        if (_body) {
            gsap = core;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_setDoc"])(_body);
            _toArray = gsap.utils.toArray;
...
// 	pending.length || func();
// }
("TURBOPACK compile-time value", "object") !== "undefined" && window.gsap && window.gsap.registerPlugin(Flip);
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/src/lib/gsap/src/utils/strings.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/lib/gsap/src/TextPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/strings.js [app-client] (ecmascript)");
;
let gsap, _tempDiv, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap;
const TextPlugin = {
    version: "3.15.0",
    name: "text",
    init (target, value, tween) {
        ...
        original = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitInnerHTML"])(target, delimiter, false, preserveSpaces, data.svg);
        _tempDiv || (_tempDiv = document.createElement("div"));
        _tempDiv.innerHTML = value.value;
        text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitInnerHTML"])(_tempDiv, delimiter, false, preserveSpaces, data.svg);
...
TextPlugin.splitInnerHTML = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitInnerHTML"];
TextPlugin.emojiSafeSplit = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"];
TextPlugin.getText = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"];
...
"[project]/apps/web/src/lib/gsap/src/utils/paths.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/lib/gsap/src/CustomEase.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/paths.js [app-client] (ecmascript)");
;
let gsap, _coreInitted, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _initCore = ()=>{
    gsap = _getGSAP();
    if (gsap) {
...
class CustomEase {
    ...
    setData(data, config) {
        ...
        if (_needsParsingExp.test(data) || ~data.indexOf("M") && data.indexOf("C") < 0) {
            values = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(data)[0];
        }
        l = values.length;
        if (l === 4) {
            values.unshift(0, 0);
    ...
    static getSVGData(ease, config) {
        ...
        if (ease instanceof CustomEase) {
            a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"])([
...
"[project]/apps/web/src/lib/gsap/src/SplitText.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/lib/gsap/src/DrawSVGPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ let gsap, _toArray, _doc, _win, _isEdge, _coreInitted, _warned, _getStyleSaver, _reverting, _windowExists = ()=>("TURBOPACK compile-time value", "object") !== "undefined", _getGSAP = ()=>gsap || _windowExists() && (gsap = window.gsap) && gsap.registerPlugin && gsap, _numExp = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, _types = {
    rect: [
        "width",
        "height"
    ],
...
"[project]/apps/web/src/lib/gsap/src/MorphSVGPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/paths.js [app-client] (ecmascript)");
;
let gsap, _toArray, _lastLinkedAnchor, _doc, _coreInitted, PluginClass, _reverting, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _isFunction = (value)=>typeof value === "function", _atan2 = Math.atan2, _cos = Math.cos, _sin = Math.sin, _sqrt = Math.sqrt, _PI = Math.PI, _2PI = _PI * 2, _angleMin = _PI * 0.3, _angleMax = _PI * 0.7, _bigNum = 1e20, _numExp = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/gi, _selectorExp = /(^[#.][a-z]|[a-y][a-z])/i, _commands = /[achlmqstvz]/i, _log = (message)=>console && console.warn(message), _round = (value)=>Math.round(value * 1e5) / 1e5 || 0, _getAverageXY = (segment)=>{
    ...
    if (checkReverse) {
        copy = sb.slice(0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reverseSegment"])(copy);
        for(i = 6; i < l; i += 6){
...
_subdivideSegmentQty = (segment, quantity)=>{
    ...
    skipMeasure || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"])(rawPath);
    ...
    if (redraw) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"])(rawPath); // only burn CPU cycles for measuring if we're redrawing
    } else {
    ...
    for(j = 0; j < sortedRawPath.length; j++){
        ...
        // do nothing (skip) if the segment is too small or if it is beyond the maximum number of segments to process (like when the corresponding segment in the start/end RawPath doesn't exist)
            ...
            smoothSegment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pointsToSegment"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["segmentToDistributedPoints"])(segment, segmentPointsToAdd), config.curviness);
            segment.length = 0;
    ...
    for(i = 0; i < start.length; i++){
        ...
        if (reverse && fillSafe !== false && !sb.reversed) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reverseSegment"])(sb);
        }
    ...
    let start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(a[0]), end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(a[1]);
    if (!_equalizeSegmentQuantity(start, end, shapeIndex || shapeIndex === 0 ? shapeIndex : "auto", map, fillSafe)) {
        return; // malformed path data or null target
    }
    a[0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])(start);
    a[1] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])(end);
    ...
    if (!isString || _selectorExp.test(shape) || (shape.match(_numExp) || []).length < 3) {
        ...
        if (e) {
            ...
            if (forcePath && type !== "PATH") {
                e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertToPath"])(e, false);
                type = "PATH";
            }
...
const MorphSVGPlugin = {
    ...
    init (target, value, tween, index, targets) {
        ...
        if (shape) {
            ...
            if (p === "d" || this._prop) {
                start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(precompiled ? value.precompile[0] : start);
                end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(precompiled ? value.precompile[1] : shape);
                if (smooth) {
                    j = start.length;
                    while(--j){
                ...
                if (value.precompile === "log" || value.precompile === true) {
                    _log('precompile:["' + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])(start) + '","' + (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])(end) + '"]');
                }
            ...
            if (pt) {
                ...
                pt.end = smooth && smooth.persist !== false ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"])(end) : shape;
                pt.endProp = p;
            }
        }
        return 1;
    ...
    render (ratio, data) {
        ...
        if (ratio === 1 && data._apply) {
            ...
            if (!ratio && _reverting()) {
                rawPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"])(data._original);
            }
    ...
    getRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRawPath"],
    stringToRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"],
    rawPathToString: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"],
    ...
    convertToPath: (targets, swap)=>_toArray(targets).map((target)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertToPath"])(target, swap !== false)),
    defaultType: "linear",
...
"[project]/apps/web/src/lib/gsap/src/ScrollSmoother.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/lib/gsap/src/Draggable.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let gsap, _win, _doc, _docElement, _body, _tempDiv, _placeholderDiv, _coreInitted, _checkPrefix, _toArray, _supportsPassive, _isTouchDevice, _touchEventLookup, _isMultiTouching, _isAndroid, InertiaPlugin, _defaultCursor, _supportsPointer, _context, _getStyleSaver, _dragCount = 0, _windowExists = ()=>("TURBOPACK compile-time value", "object") !== "undefined", _getGSAP = ()=>gsap || _windowExists() && (gsap = window.gsap) && gsap.registerPlugin && gsap, _isFunction = (value)=>typeof value === "function", _isObject = (value)=>typeof value === "object", _isUndefined = (value)=>typeof value === "undefined", _emptyFunc = ()=>false, _transformProp = "transform", _transformOriginProp = "transformOrigin", _round = (value)=>Math.round(value * 10000) / 10000, _isArray = Array.isArray, _createElement = (type, ns)=>{
...
}, _RAD2DEG = 180 / Math.PI, _bigNum = 1e20, _identityMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix2D"](), _getTime = Date.now || (()=>new Date().getTime()), _renderQueue = [], _lookup = {}, _lookupCount = 0, _clickableTagExp = /^(?:a|input|textarea|button|select)$/i, _lastDragTime = 0, _temp1 = {}, _windowProxy = {}, _copy = (obj, factor)=>{
    let copy = {}, p;
    for(p in obj){
    ...
    matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(context, true).multiply((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(element));
    p1 = matrix.apply({
        x: left,
        y: top
    });
...
class Draggable extends EventDispatcher {
    constructor(target, vars){
        ...
        syncXY = (skipOnUpdate, skipSnap)=>{
            ...
            let start = matrix, p;
            matrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(target.parentNode, true);
            if (shiftStart && self.isPressed && !matrix.equals(start || new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix2D"]())) {
            ...
            innerMatrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(target);
            if (scrollProxy) {
                calculateBounds();
                ...
                if (rotationMode) {
                    ...
                    rotationOrigin = self.rotationOrigin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(target).apply({
        ...
        this.update = (applyBounds, sticky, ignoreExternalChanges)=>{
            if (sticky && self.isPressed) {
                if (rotationMode) {
                    ...
                    let m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(target), p = innerMatrix.apply({
                        x: self.x - startElementX,
                        y: self.y - startElementY
                    }), m2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(target.parentNode, true);
                    m2.apply({
                        x: m.e - p.x,
                        y: m.f - p.y
                    }, p);
...
"[project]/apps/web/src/lib/gsap/src/utils/VelocityTracker.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let gsap, _coreInitted, _toArray, _getUnit, _first, _ticker, _time1, _time2, _getCache, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap), _lookup = {}, _round = (value)=>Math.round(value * 10000) / 10000, _getID = (target)=>_getCache(target).id, _getByTarget = (target)=>_lookup[_getID(typeof target === "string" ? _toArray(target)[0] : target)], _onTick = (time)=>{
    let pt = _first, val;
...
"[project]/apps/web/src/lib/gsap/src/InertiaPlugin.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$VelocityTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/VelocityTracker.js [app-client] (ecmascript)");
;
let gsap, _coreInitted, _parseEase, _toArray, _power3, _config, _getUnit, PropTween, _getCache, _checkPointRatio, _clamp, _processingVars, _getStyleSaver, _reverting, _getTracker = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$VelocityTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VelocityTracker"].getByTarget, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _isString = (value)=>typeof value === "string", _isNumber = (value)=>typeof value === "number", _isObject = (value)=>typeof value === "object", _isFunction = (value)=>typeof value === "function", _bonusValidated = 1, _isArray = Array.isArray, _emptyFunc = (p)=>p, _bigNum = 1e10, _tinyNum = 1 / _bigNum, _checkPoint = 0.05, _round = (value)=>Math.round(value * 10000) / 10000, _extend = (obj, defaults, exclude)=>{
    for(let p in defaults){
    ...
    if (gsap) {
        ...
        _config = gsap.config();
        gsap.registerPlugin(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$VelocityTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VelocityTracker"]);
        _coreInitted = 1;
    }
};
const InertiaPlugin = {
...
"track,untrack,isTracking,getVelocity,getByTarget".split(",").forEach((name)=>InertiaPlugin[name] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$VelocityTracker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VelocityTracker"][name]);
...
"[project]/apps/web/src/lib/gsap/src/MotionPathPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * @author: Jack Doyle, jack@greensock.com
*/ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/paths.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/utils/matrix.js [app-client] (ecmascript)");
;
;
let _xProps = "x,translateX,left,marginLeft,xPercent".split(","), _yProps = "y,translateY,top,marginTop,yPercent".split(","), _DEG2RAD = Math.PI / 180, gsap, PropTween, _getUnit, _toArray, _getStyleSaver, _reverting, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _populateSegmentFromArray = (segment, values, property, mode)=>{
...
_segmentToRawPath = (plugin, segment, target, x, y, slicer, vars, unitX, unitY)=>{
    if (vars.type === "cubic") {
        ...
        let pointFunc = y ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pointsToSegment"] : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["flatPointsToSegment"];
        segment = [
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"])(segment, vars.resolution || (vars.curviness === 0 ? 20 : 12)); //when curviness is 0, it creates control points right on top of the anchors which makes it more sensitive to resolution, thus we change the default accordingly.
}, _emptyFunc = (v)=>v, _numExp = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g, _originToPoint = (element, origin, parentMatrix)=>{
    let m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(element), x = 0, y = 0, svg;
    ...
    let parentMatrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(fromElement.parentNode, true, true), m = parentMatrix.clone().multiply((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"])(toElement)), fromPoint = _originToPoint(fromElement, fromOrigin, parentMatrix), { x, y } = _originToPoint(toElement, toOrigin, parentMatrix), p;
    m.e = m.f = 0;
    ...
    if (!rawPath || !rawPath.length) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRawPath"])("M0,0L0,0");
    }
    if (align) {
        if (align === "self" || (alignTarget = _toArray(align)[0] || target) === target) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"])(rawPath, 1, 0, 0, 1, curX - x, curY - y);
        } else {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"])(rawPath, m.a, m.b, m.c, m.d, curX + m.e - (p.x - m.e), curY + m.f - (p.y - m.f));
        }
    }
    if (matrix) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"])(rawPath, matrix.a, matrix.b, matrix.c, matrix.d, matrix.e, matrix.f);
    } else if (offsetX || offsetY) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"])(rawPath, 1, 0, 0, 1, offsetX || 0, offsetY || 0);
    }
    return rawPath;
...
}, _sliceModifier = (start, end)=>(rawPath)=>start || end !== 1 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sliceRawPath"])(rawPath, start, end) : rawPath;
const MotionPathPlugin = {
    ...
    init (target, vars, tween) {
        ...
        if (Array.isArray(path) && !("closed" in path) && typeof firstObj !== "number") {
            ...
            rawPath = slicer(_align((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRawPath"])(vars.path), target, vars));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"])(rawPath, vars.resolution);
    ...
    render (ratio, data) {
        ...
        if (data.tween._time || !_reverting()) {
            ...
            while(i--){
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionOnPath"])(rawPaths[i], ratio, !i && data.rotate, rawPaths[i]);
            }
            while(pt){
    ...
    getLength (path) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRawPath"])(path)).totalLength;
    },
    sliceRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sliceRawPath"],
    getRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRawPath"],
    pointsToSegment: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pointsToSegment"],
    stringToRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringToRawPath"],
    rawPathToString: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rawPathToString"],
    transformRawPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformRawPath"],
    getGlobalMatrix: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalMatrix"],
    getPositionOnPath: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionOnPath"],
    cacheRawPathMeasurements: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheRawPathMeasurements"],
    convertToPath: (targets, swap)=>_toArray(targets).map((target)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertToPath"])(target, swap !== false)),
    ...
    arrayToRawPath (value, vars) {
        ...
        vars.relative && _relativize(segment);
        return [
            vars.type === "cubic" ? segment : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$paths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pointsToSegment"])(segment, vars.curviness)
        ];
    }
};
...
"[project]/apps/web/src/lib/gsap/src/ScrambleTextPlugin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CharSet {
    constructor(chars){
        this.chars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(chars);
        this.sets = [];
        this.length = 50;
        for(let i = 0; i < 20; i++){
...
let gsap, _coreInitted, _getGSAP = ()=>gsap || ("TURBOPACK compile-time value", "object") !== "undefined" && (gsap = window.gsap) && gsap.registerPlugin && gsap, _bonusValidated = 1, _spacesExp = /\s+/g, _scrambleText = (length, chars)=>{
...
const ScrambleTextPlugin = {
    ...
    init (target, value, tween, index, targets) {
        ...
        data.original = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"])(target).replace(_spacesExp, " ").split("&nbsp;").join(""), delim, trim);
        if (text === "{original}" || text === true || text == null) {
            text = data.original.join(delim);
        }
        data.text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])((text || "").replace(_spacesExp, " "), delim, trim);
        data.hasClass = !!(value.newClass || value.oldClass);
        data.newClass = value.newClass;
        data.oldClass = value.oldClass;
        splitByChars = delim === "";
        data.textHasEmoji = splitByChars && !!data.text.emoji;
        data.charsHaveEmoji = !!value.chars && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(value.chars).emoji;
    ...
    render (ratio, data) {
        ...
        if (rightToLeft) {
            if (ratio === 1 && (tween._from || tween.data === "isFromStart")) {
                ...
                if (charsHaveEmoji) {
                    startText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(endText).slice(0, position - (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(str) : str).length + 0.5 | 0).join("");
                } else {
                    startText = endText.substr(0, position - (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(str) : str).length + 0.5 | 0);
                }
                endText = str;
            }
        } else {
            startText = text.slice(0, i).join(delimiter);
            i2 = (textHasEmoji ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(startText) : startText).length;
            if (charsHaveEmoji) {
                endText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"])(endText).slice(i2, position + 0.5 | 0).join("");
            } else {
...
ScrambleTextPlugin.emojiSafeSplit = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emojiSafeSplit"];
ScrambleTextPlugin.getText = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$utils$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"];
...
"[project]/apps/web/src/lib/gsap/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
// Core & Public Plugins
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/ScrollTrigger.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollToPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/ScrollToPlugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Flip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/Flip.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/Observer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$TextPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/TextPlugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$CustomEase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/CustomEase.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$SplitText$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/SplitText.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$DrawSVGPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/DrawSVGPlugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$MorphSVGPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/MorphSVGPlugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollSmoother$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/ScrollSmoother.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Draggable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/Draggable.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$InertiaPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/InertiaPlugin.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$MotionPathPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/MotionPathPlugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrambleTextPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/src/ScrambleTextPlugin.js [app-client] (ecmascript)");
'use client';
;
;
;
...
if ("TURBOPACK compile-time truthy", 1) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].registerPlugin(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollToPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollToPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Flip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flip"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Observer"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$TextPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$CustomEase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomEase"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$SplitText$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SplitText"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$DrawSVGPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DrawSVGPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$MorphSVGPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MorphSVGPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrollSmoother$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollSmoother"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$Draggable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Draggable"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$InertiaPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["InertiaPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$MotionPathPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MotionPathPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$src$2f$ScrambleTextPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrambleTextPlugin"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"]);
}
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/apps/web/src/components/home/HeroSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@gsap/react/src/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$gsap$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/apps/web/src/lib/gsap/index.ts [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$bilingual$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/ui/bilingual.tsx [app-client] (ecmascript)");
...
function HeroSection() {
    ...
    const heroTextRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    const isoCardsRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$bilingual$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Bilingual"], {
...
_s(HeroSection, "ad1ffy/l0v0QsKtwUA/lFx5l5YM=", false, function() {
    return [
...
"[project]/apps/web/src/content/mock/products.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Card = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c = ({ className, ...props }, ref)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-xl border border-border bg-card text-card-foreground shadow-xs transition-all duration-150 hover:shadow-md", className),
        ...props
    }, void 0, false, {
...
const CardTitle = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c4 = ({ className, ...props }, ref)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-heading text-lg font-semibold leading-none tracking-tight text-[var(--color-ink-900)]", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/apps/web/src/components/ui/card.tsx",
        lineNumber: 35,
...
"[project]/apps/web/src/components/ui/product-icon-block.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const categoryIconMap = {
    paper: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$book$2d$open$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BookOpen$3e$__["BookOpen"],
    pens: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$pen$2d$tool$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__PenTool$3e$__["PenTool"],
    office: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$package$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Package$3e$__["Package"],
    files: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$layers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Layers$3e$__["Layers"],
    cutting: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$scissors$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Scissors$3e$__["Scissors"],
    art: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bookmark$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Bookmark$3e$__["Bookmark"],
    general: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"]
};
const sizeClasses = {
    sm: "p-3 [&_svg]:size-5",
    md: "p-4 [&_svg]:size-8",
 ...
 */ function ProductIconBlock({ icon, category = "general", size = "md", aspectRatio = "square", className, ...props }) {
    const IconComponent = icon || categoryIconMap[category] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
;
var _c;
__turbopack_context__.k.register(_c, "ProductIconBlock");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/src/lib/pricing.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/components/catalogue/ProductCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$bilingual$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/ui/bilingual.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$product$2d$icon$2d$block$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/ui/product-icon-block.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pricing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/pricing.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$hooks$2f$use$2d$cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/hooks/use-cart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shopping$2d$bag$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShoppingBag$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/shopping-bag.mjs [app-client] (ecmascript) <export default as ShoppingBag>");
...
function ProductCard({ product, pricingContext }) {
    _s();
    const { addItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$hooks$2f$use$2d$cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const [notified, setNotified] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    const resolvedPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pricing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveDisplayPrice"])(product, pricingContext);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "relative",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$product$2d$icon$2d$block$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductIconBlock"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-1",
                        children: [
                            product.shopName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            product.nameUrdu && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                dir: "rtl",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pricing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPKR"])(resolvedPrice)
                            }, void 0, false, {
                                fileName: "[project]/apps/web/src/components/catalogue/ProductCard.tsx",
                                lineNumber: 96,
                                columnNumber: 11
...
_s(ProductCard, "rNyekr6GCd9UTjqnRcN6iKm46Fk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$hooks$2f$use$2d$cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
_c = ProductCard;
var _c;
...
"[project]/apps/web/src/components/motion/stagger-list.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function StaggerList({ staggerDelay = 0.04, maxTotalStagger = 0.28, children, className, ...props }) {
    ...
    const childArray = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Children"].toArray(children);
...
_s(StaggerList, "C9xMdslg1Z8O8dPJqeHy1pZYGWc=", false, function() {
    return [
...
;
var _c;
__turbopack_context__.k.register(_c, "StaggerList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Tabs({ defaultValue, value: controlledValue, onValueChange, className, children, ...props }) {
    _s1();
    const [uncontrolledValue, setUncontrolledValue] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](defaultValue ?? "");
...
_s1(Tabs, "rdoRRq/3wq5VetX50ZYi550qcTM=");
_c = Tabs;
function TabsList({ className, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/apps/web/src/components/ui/tabs.tsx",
        lineNumber: 63,
...
function TabsTrigger({ className, value, children, ...props }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", isSelected ? "bg-background text-foreground shadow-xs font-semibold" : "hover:text-foreground hover:bg-background/40", className),
        ...props,
        children: children
    }, void 0, false, {
        fileName: "[project]/apps/web/src/components/ui/tabs.tsx",
...
function TabsContent({ className, value, children, ...props }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        role: "tabpanel",
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring", className),
        ...props,
        children: children
    }, void 0, false, {
        fileName: "[project]/apps/web/src/components/ui/tabs.tsx",
...
"[project]/apps/web/src/components/home/FeaturedSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$content$2f$mock$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/content/mock/products.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$catalogue$2f$ProductCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/catalogue/ProductCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$motion$2f$stagger$2d$list$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/motion/stagger-list.tsx [app-client] (ecmascript)");
...
function FeaturedSection() {
    _s();
    const [pricingMode, setPricingMode] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]("guest");
    const pricingContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "FeaturedSection.useMemo[pricingContext]": ()=>{
    ...
    const restockedProducts = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$content$2f$mock$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProducts"].slice(0, 4);
    const bestsellerProducts = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$content$2f$mock$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProducts"].slice(2, 6);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tabs"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                            value: "restocked",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$motion$2f$stagger$2d$list$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaggerList"], {
                                className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6",
                                children: restockedProducts.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$catalogue$2f$ProductCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductCard"], {
                                        product: product,
...
_s(FeaturedSection, "kes1kbR+J8mSwZoIn9jrpwKbFxA=");
_c = FeaturedSection;
var _c;
...
//# sourceMappingURL=apps_web_src_1awhhed._.js.map